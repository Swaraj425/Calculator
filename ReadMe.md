...
## Usage
1. Open the application in your browser at http://localhost:"your-port"/ (default is 5174 if using Vite) or you can directly visit it on the link : https://calculator-frontend-2gaz.onrender.com/.
